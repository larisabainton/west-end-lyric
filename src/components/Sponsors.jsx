                ...
                <div className="sponsors_list">
                    <div className="sponsors_list-item">
                        <div className="sponsors-photo">
                            <StaticImage 
                                src='../images/sponsor-logos/boston_synagogue_logo.png' 
                                alt="Boston Synagogue Logo"
                            /></div>
                    ...
                    <div className="sponsors_list-item">
                        <div className="sponsors-photo">
                            <StaticImage 
                                src='../images/sponsor-logos/backroom_boston_logo.png' 
                                alt="Backroom Boston Logo"
                            /></div>
                    ...
                    <div className="sponsors_list-item">
                        <div className="sponsors-photo">
                            <StaticImage 
                                src="../images/sponsor-logos/mcc_logo.jpg" 
                                alt="Mass Cultural Council Logo"
                            /></div>
